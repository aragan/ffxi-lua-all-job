...
function init_gear_sets()
    ...
    sets.precast.WS = {
        ...
        hands={ name="Valorous Mitts", augments={'Accuracy+23 Attack+23','Weapon skill damage +3%','AGI+7','Accuracy+11',}},
        legs="Wakido Haidate +3",
        feet={ name="Valorous Greaves", augments={'Weapon skill damage +4%','DEX+9','Accuracy+13 Attack+13',}},
